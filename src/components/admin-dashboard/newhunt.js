...
const AdminPortor = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://zakhari-a63a222c7c96.herokuapp.com/api/v2/ibex/newhunt', formData);
    ...
    return (
        <div className="admin_portor_container">
            <div className="admin_portor_head">
                <h2 className="admin_portor_heading">Add NEW Hunt</h2>
            </div>
