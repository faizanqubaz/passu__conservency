            ...
            <div className="discount_detail_container">
                <div className='discount_detail_main_container_content'>
                    ...
                    <div>
                        ...
                        <p className='discount_detail_main_container_content_two_para_two previous-price'>$9000</p>
            ...
            <div className='discount_detail_dolar_main_container'>
                ...
                <div className='discount_detail_dolar_main_container_two'>
                    ...
                    <div className='discount_detail_dolar_main_container_two_dolar_head'>
                        <h2 className='discount_detail_dolar_main_container_two_dolar_head_heading'>US$, 5000</h2>
                        <p className='discount_detail_dolar_main_container_two_dolar_head_para previous-price'>US$,6000</p>
                    </div>
